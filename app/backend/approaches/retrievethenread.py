...
"""
    ...
    def run(self, q: str, overrides: dict) -> any:
        ...
        if use_semantic_captions:
            results = [doc[self.content_field] + ": " + nonewlines(" . ".join([c.text for c in doc['@search.captions']])) for doc in r]
        else:
            results = [doc[self.content_field] + ": " + nonewlines(doc[self.content_field]) for doc in r]
        content = "\n".join(results)
